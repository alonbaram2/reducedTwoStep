...
class MF_MBi(RL_agent):
    'Mixture agent with initial transition probabilities as model-parameter.'

    def __init__(self, kernels = ['bs', 'ck', 'rb']):
        self.name = 'MF_MBi'
        self.param_names  = ['alpQ', 'lbd' , 'alpT', 'initT', 'G_td', 'G_mb']
    ...
    def session_likelihood(self, session, params_T, get_DVs = False):
        ...
        # Unpack parameters.
        alpQ, lbd, alpT, initT, G_td, G_mb = params_T[:6]
